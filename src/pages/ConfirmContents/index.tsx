...
import useConfirmContentsParams, {ConfirmContentsType} from "../../hooks/pathParams/useConfirmContentsParams";
...
export default function ConfirmContentsPage() {
    ...
    const renderTypeButton = (t: ConfirmContentsType) => {
        if (t === type) return <button><strong>{t}</strong></button>
